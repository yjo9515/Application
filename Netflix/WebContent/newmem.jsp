...
<body>
    <div class="content">
        ...
        <form name="action" id="action" action="action.jsp" method="get" >
        <div class="newmem">
            ...
            <button type="button" form="action" class="buttons"  id="submit_btn" >회원가입 완료</button>
